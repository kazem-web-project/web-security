document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("xml-file-input").addEventListener("change", function () {
        ...
        fetch("xml.php", {
            ...
            .then(result => {
                addMessage("XML file uploaded successfully. Here's the result:", "user");
                addMessage(result, "bot");
            })
            .catch(error => {
                console.error("Error uploading XML:", error);
                addMessage("Failed to send invoice. Please try again.", "bot");
            });
