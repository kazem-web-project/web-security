                        ...
                        <div class="col-lg-8">
                            <div class="ps-lg-1-6 ps-xl-5">
                                <div class="mb-5 wow fadeIn news_card">
                                    ...
                                    <p>My name is Kazem Gholibeigian and I'm from Iran. I have lived in Vienna since 2014. I'm studying computer science (computer science in the dual form) at the Technical University of Applied Sciences (FH-Technikum). </p>
                                    <p class="mb-0">I graduated in IT (System Technology) from the HTL Ottakring (Wien West).
                                        I programmed the website myself!</p>
                                </div>
                                        ...
                                        <div class="col-sm-6 col-xl-4 mt-4">
                                            <div class="card text-center border-0 rounded-3">
                                                <div class="card-body experience-card">
                                                    ...
                                                    <p class="mb-0">I have worked as a plumber and network technician in Iran.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
